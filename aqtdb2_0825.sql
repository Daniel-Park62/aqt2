...
/*	
	...
	END if ;
*/
	UPDATE ttcppacket d, ttcppacket s SET d.rcode = 0 , d.rhead = '미수행', d.slen = s.slen, d.rlen = 0, d.sdata = s.sdata, d.rdata = NULL , d.stime = s.stime, d.rtime = s.rtime, d.elapsed = 0
...
-- 테이블 aqtdb2.tapplication 구조 내보내기
...
) ENGINE=InnoDB AUTO_INCREMENT=513 DEFAULT CHARSET=utf8 COMMENT='서비스 id / name';
...
-- 뷰 aqtdb2.vtcppacket 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
CREATE TABLE `vtcppacket` (
	`pkey` INT(10) UNSIGNED NOT NULL,
	`cmpid` INT(10) UNSIGNED NOT NULL,
	...
	`stime` DATETIME(6) NOT NULL COMMENT '송신시간',
	`rtime` DATETIME(6) NOT NULL COMMENT '수신시간',
	`svctime` DOUBLE(22,3) NULL,
	`elapsed` DOUBLE(22,3) NOT NULL COMMENT '소요시간',
	...
	`uri` VARCHAR(512) NULL COLLATE 'utf8_general_ci',
	`seqno` INT(10) UNSIGNED NULL,
	`ackno` INT(10) UNSIGNED NULL,
	`rcode` INT(10) UNSIGNED NULL COMMENT 'return code',
	`sflag` CHAR(1) NULL COLLATE 'utf8_general_ci',
	`rhead` VARCHAR(8192) NULL COMMENT 'response header' COLLATE 'utf8_general_ci',
	...
	`cdate` DATETIME(6) NULL COMMENT '생성일시',
	...
	`svc_cnt` INT(10) UNSIGNED NULL,
	`fsvc_cnt` INT(10) UNSIGNED NULL,
	`data_cnt` INT(10) UNSIGNED NULL,
	`scnt` INT(10) UNSIGNED NULL,
	`fcnt` INT(10) UNSIGNED NULL
) ENGINE=MyISAM;

-- 뷰 aqtdb2.vtransaction 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
CREATE TABLE `vtransaction` (
	...
	`svcid` VARCHAR(50) NULL COMMENT '서비스id' COLLATE 'utf8_general_ci',
	...
	`dstip` VARCHAR(40) NULL COLLATE 'utf8_general_ci',
	`dstport` INT(10) UNSIGNED NULL,
	`scrno` VARCHAR(20) NULL COMMENT '화면ID' COLLATE 'utf8_general_ci',
	`msgcd` VARCHAR(10) NULL COMMENT '수신메세지코드' COLLATE 'utf8_general_ci',
	`rcvmsg` VARCHAR(120) NULL COMMENT '수신메세지' COLLATE 'utf8_general_ci',
	`errinfo` VARCHAR(120) NULL COLLATE 'utf8_general_ci',
	...
	`elapsed` DOUBLE(22,3) NULL,
	`svctime` DOUBLE(22,3) NULL COMMENT '순수서비스소요시간',
	`slen` INT(10) UNSIGNED NULL COMMENT '송신데이터길이',
	`rlen` INT(10) UNSIGNED NULL COMMENT '수신데이터길이',
	`sdata` MEDIUMBLOB NULL COMMENT '송신데이터',
	`rdata` MEDIUMBLOB NULL COMMENT '수신데이터',
	`cdate` DATETIME(6) NULL COMMENT '생성시간',
	`appid` VARCHAR(50) NOT NULL COLLATE 'utf8_general_ci',
	`code` VARCHAR(20) NOT NULL COLLATE 'utf8_general_ci',
	`type` CHAR(1) NULL COMMENT '1.배치테스트 2.실시간' COLLATE 'utf8_general_ci',
	`lvl` CHAR(1) NULL COMMENT '0.ORIGIN 1.단위  2.통합테스트' COLLATE 'utf8_general_ci',
...
CREATE TABLE `vtrxdetail` (
	`pkey` INT(1) NOT NULL,
	`tcode` VARCHAR(20) NOT NULL COLLATE 'utf8mb4_general_ci',
	`svcid` VARCHAR(60) NOT NULL COLLATE 'utf8mb4_general_ci',
	`scrno` VARCHAR(60) NOT NULL COLLATE 'utf8mb4_general_ci',
	`svckor` VARCHAR(60) NOT NULL COLLATE 'utf8mb4_general_ci',
	`tcnt` INT(1) NOT NULL,
	`avgt` DECIMAL(4,2) NOT NULL,
	`scnt` INT(1) NOT NULL,
	`fcnt` INT(1) NOT NULL,
	`cumcnt` INT(1) NOT NULL
) ENGINE=MyISAM;
...
DROP TABLE IF EXISTS `vtcppacket`;
