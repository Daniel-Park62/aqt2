...
CREATE TABLE IF NOT EXISTS `tconfig` (
  ...
  `pjtnm` VARCHAR(200) COLLATE 'utf8_general_ci',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `tconfig` (`id`, `pass1`, `TCODE`,proto,encval, pjtnm) VALUES
	(1, 'testadmin', NULL, '0','MS949', 'Project 식별명');
...
DECLARE cur2 CURSOR FOR 
	SELECT pkey, o_stime, rtime, elapsed, srcip, srcport, dstip, dstport, proto, method, 
			seqno, ackno, slen, rlen, sdata, rdata, errinfo,rhead
	 FROM vtloaddata t
	WHERE uri = s_uri
...
CREATE TABLE IF NOT EXISTS `tloaddata` (
  ...
  KEY `uri` (`uri`,`o_stime`)
) ENGINE=InnoDB AUTO_INCREMENT=4284485390 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=564 DEFAULT CHARSET=utf8 COMMENT='서비스 id / name';
...
CREATE TABLE IF NOT EXISTS `ttcppacket` (
  ...
  KEY `cmpid` (`cmpid`),
  KEY `tcode` (`tcode`,`o_stime`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=59705 DEFAULT CHARSET=utf8;
