...
//		}
	...
	private ITableLabelProvider myLabelProvider = new  ITableLabelProvider() {
		...
		public String getColumnText(Object element, int columnIndex) {
			Thostmap thostmap = (Thostmap)element ;
			if ( thostmap == null )  return null ;
			
			switch (columnIndex) {
			case 0:
				return thostmap.getThost() ; 
			case 1:
				return thostmap.getTport() + "" ;
			case 2:
				return thostmap.getThost2() ;
			case 3:
				return thostmap.getTport2() + "" ;
			}
			return null;
		}
